...
const useStyles = makeStyles(theme => ({
  root: {
    ...
    [theme.breakpoints.up('md')]: {
      backgroundImage: theme.palette.type === 'light' ? `linear-gradient(to left, rgba(255, 255, 255, 0) 20%, ${alpha(theme.palette.secondary.light, 0.3)} 10%)` : `linear-gradient(to left, rgba(255, 255, 255, 0) 20%, ${alpha(theme.palette.secondary.dark, 0.3)} 10%)`
    },
    '& > *': {
      position: 'relative'
    }
