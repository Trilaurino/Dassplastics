		...
		<div className={classes.root}>
			<Dialog
				...
				<DialogTitle id='alert-dialog-slide-title'>
					{t('common:dassplastic-landing.blog_video')}
			...
			<Container fixed>
				<Box p={isDesktop ? 6 : 0}>
					<Title
						head={t('common:dassplastic-landing.blog_title')}
						desc={t('common:dassplastic-landing.blog_desc')}
						align='left'
						color='secondary'
					/>
					<Grid
								...
								<div className={classes.videoCarousel}>
									<Carousel {...settings}>
										<Paper className={classes.item}>
											<img src={imgAPI.dassplastic[14]} alt='cover' />
											<IconButton
												className={classes.playBtn}
												onClick={() => handleClickOpen('6p0VM-yUpGk')}>
												<PlayIcon />
											</IconButton>
										</Paper>
										<Paper className={classes.item}>
											<img src={imgAPI.dassplastic[15]} alt='cover' />
											<IconButton
												className={classes.playBtn}
												onClick={() => handleClickOpen('HBeJA3q19mk')}>
												<PlayIcon />
											</IconButton>
										</Paper>
										<Paper className={classes.item}>
											<img src={imgAPI.dassplastic[16]} alt='cover' />
											<IconButton
												className={classes.playBtn}
												onClick={() => handleClickOpen('6p0VM-yUpGk')}>
												<PlayIcon />
										...
										<Paper className={classes.item}>
											<img src={imgAPI.dassplastic[17]} alt='cover' />
											<IconButton
												className={classes.playBtn}
												onClick={() => handleClickOpen('HBeJA3q19mk')}>
												<PlayIcon />
